/*
 * SECURE ESP32 V2X System - Vehicle 1 (SDV001)
...
String VEHICLE_ID = "SDV001";  // Vehicle 1
...
void setup() {
  ...
  Serial.println("\n=== SECURE ESP32 V2X - Vehicle 1 (SDV001) ===");
